...
public class ProductService {
	...
	public List<ProductCardResponse> getLatestProducts() {
	    ...
	    for (Product product : products) {
	        ...
	        List<ProductImage> mainAndSecondaryImages = product.getImages().stream()
	            .filter(image -> image.getImageType() == ImageType.MAIN || image.getImageType() == ImageType.SECONDARY)
	        ...
	        for (Variant variant : product.getVariants()) {
	            if (variant.getColor() != null) {
	                String code = variant.getColor().getColorCode();
	...
	public List<ProductSuggestResponse> getProductsSuggest() {
	    ...
	    for (Product product : products) {
	        ...
	        for (Variant variant : product.getVariants()) {
	            ...
	            variantDTO.setMaterialName(variant.getMaterial() != null ? variant.getMaterial().getMaterialName() : null);
